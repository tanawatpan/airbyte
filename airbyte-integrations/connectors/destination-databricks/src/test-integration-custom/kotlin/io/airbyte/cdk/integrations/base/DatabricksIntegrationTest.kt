...
abstract class DatabricksIntegrationTest {
    ...
    fun testSync(catalogFile: String, messageFile: String) {
        ...
        mockkObject(IntegrationRunner.Companion)
        justRun { IntegrationRunner.stopOrphanedThreads() }
    ...
    open fun retrieveRecords(
        ...
        return database.query { ctx ->
            ...
            """.trimIndent(),
                ...
                Jsons.deserialize(record.formatJSON(JdbcUtils.defaultJSONFormat)).let { json ->
