...
public class DatabricksConstants {
    ...
    public static final String DATABRICKS_ENABLE_OPTIMIZE_TABLE_KEY = "optimize_table";
    public static final String DATABRICKS_ENABLE_VACUUM_TABLE_KEY = "vacuum_table";
    public static final String DATABRICKS_DEFAULT_VACUUM_RETENTION_HOURS_KEY = "vacuum_retention_hours";
    public static final int DATABRICKS_DEFAULT_VACUUM_RETENTION_HOURS = 168;
    public static final String DATABRICKS_ENABLE_EXPERIMENTAL_FEATURES_KEY = "experimental_features";
